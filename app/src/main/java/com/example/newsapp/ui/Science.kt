...
@AndroidEntryPoint
class Science : AppCompatActivity(), NewsAdapter.ClickHandle {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel.getNewsFromRepo("Science")

        pbScience.visibility= View.VISIBLE
        rvScience.layoutManager= LinearLayoutManager(this)
